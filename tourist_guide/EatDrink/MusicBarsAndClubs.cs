...
namespace WinFormsApp3
{
    ...
    public partial class MusicBarsAndClubs : Form
    {
        int querriesffected;
        private int ImageNumber = 34;
        String date;
        String date_now;
        String note;
        public MusicBarsAndClubs()
        {
            InitializeComponent();
            timer1.Enabled = true;
        ...
        private void printingBtn1_Click(object sender, EventArgs e)
        {
